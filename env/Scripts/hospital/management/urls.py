...
urlpatterns = [
   ...
   #---------------------STAFF-------------------------------#
    ...
    #---------------------docteur-------------------------------#
    path('service_receptionist/doctors/', department_doctors, name="department_doctors"), #ajouté
   ...
   #---------------------receptionists-------------------------------#
    ...
    #---------------------me-------------------------------#
    path('service_receptionist/my_profile_Service_receptionist/', me_service_receptionist, name="meServiceReceptionist"), #ajouté
    #logout
    #---------------------me-------------------------------#
